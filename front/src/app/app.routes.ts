...
import { StudentGroupsComponent } from './components/groups/student-groups/student-groups.component';
import { StudentLecturesComponent } from './components/groups/student-lectures/student-lectures.component';
...
export const routes: Routes = [
    ...
    {path: "groups/studentGroup", component: StudentGroupsComponent},
    {path: "groups/:id/lectures", component: StudentLecturesComponent},
    ...
    {path: "lectures/files/:id", component: UpdateLectureComponent},
